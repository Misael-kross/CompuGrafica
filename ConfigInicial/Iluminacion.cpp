...
int main()
{
    ...
    GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 8_Misael Ivan Sosa Cortez", nullptr, nullptr);
    ...
    while (!glfwWindowShouldClose(window))
    {
        ...
        glUniform3f(lightPosLoc2, lightPos2.x + movelightPos2, lightPos2.y, lightPos2.z);
        ...
        //Luz numero 2
        model = glm::mat4(1.0f);
        model = glm::translate(model, lightPos2 + glm::vec3(movelightPos2, 0.0f, 0.0f));
        model = glm::scale(model, glm::vec3(0.3f));
        glUniformMatrix4fv(glGetUniformLocation(lampshader.Program, "model"), 1, GL_FALSE, glm::value_ptr(model));
        glBindVertexArray(VAO);
        glDrawArrays(GL_TRIANGLES, 0, 36);
