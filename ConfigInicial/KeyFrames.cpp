...
int main()
{
	...
	GLFWwindow* window = glfwCreateWindow(WIDTH, HEIGHT, "Previo 12_Misael Ivan Sosa Cortez", nullptr, nullptr);
...
void DoMovement()
{
	...
	// Movimiento de la luz (más lento también)
	if (keys[GLFW_KEY_I])
	{
